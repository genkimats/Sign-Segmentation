        ...
        experiments_to_run = [
            {
                ...
                "batch_size": 8,
                "description": "overlap ratio (0/16), loss=weighted_ce(0.5,0.7,1.0), batch=8, no kinetic"
            },
            {
                "window_size": 32,
                "overlap": 0,
                ...
                "class_weights": [0.5, 0.7, 1.0],
                "batch_size": 8,
                "description": "overlap ratio (0/32), loss=weighted_ce(0.5,0.7,1.0), batch=8, no kinetic"
            },
            {
                "window_size": 64,
                "overlap": 0,
                ...
                "class_weights": [0.5, 0.7, 1.0],
                "batch_size": 8,
                "description": "overlap ratio (0/64), loss=weighted_ce(0.5,0.7,1.0), batch=8, no kinetic"
            },
            {
                "window_size": 128,
                "overlap": 0,
                ...
                "class_weights": [0.5, 0.7, 1.0],
                "batch_size": 8,
                "description": "overlap ratio (0/128), loss=weighted_ce(0.5,0.7,1.0), batch=8, no kinetic"
            },
            {
                "window_size": 256,
                "overlap": 0,
                ...
                "class_weights": [0.5, 0.7, 1.0],
                "batch_size": 8,
                "description": "overlap ratio (0/256), loss=weighted_ce(0.5,0.7,1.0), batch=8, no kinetic"
            },
            {
                "window_size": 512,
                "overlap": 0,
                ...
                "class_weights": [0.5, 0.7, 1.0],
                "batch_size": 8,
                "description": "overlap ratio (0/512), loss=weighted_ce(0.5,0.7,1.0), batch=8, no kinetic"
            }
        ]
